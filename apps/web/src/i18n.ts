...
export const dict = {
  hu: {
    ...
    logout: "Kilépés",
    today: "Ma",
    diary: { previousDay: "Előző nap", nextDay: "Következő nap", selectDate: "Dátum kiválasztása", noMeals: "Ezen a napon nem volt rögzített étkezés." },
  ...
  de: {
    ...
    logout: "Abmelden",
    today: "Heute",
    diary: { previousDay: "Vorheriger Tag", nextDay: "Nächster Tag", selectDate: "Datum auswählen", noMeals: "An diesem Tag wurden keine Mahlzeiten erfasst." },
  ...
  en: {
    ...
    logout: "Log out",
    today: "Today",
    diary: { previousDay: "Previous day", nextDay: "Next day", selectDate: "Select date", noMeals: "No meals logged for this day." },
