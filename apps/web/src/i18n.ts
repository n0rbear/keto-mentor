  ...
  hu: {
    ...
    foodUnderstanding: {
      ...
      recipeDiscovery: {
        ...
        referenceMatch: "Megtaláltuk a Keto Mentor ételadatbázisában:",
        ambiguousLocal: "Több hasonló nevű saját recepted is van — válassz egyet.",
        ambiguousReference: "Melyik változatot etted? Válaszd ki (pl. a köretet).",
        sourceOwn: "Saját recept",
        sourceReference: "Keto Mentor ételadatbázis",
        servingApprox: "1 adag ≈ {g} g",
    ...
    recipes: {
      ...
      totalNutrition: "Teljes recept", partialNutrition: "Feloldott összetevők részösszege", ingredientsProgress: "{resolved} / {total} összetevő feloldva", ingredientsNeedReview: "{n} összetevő még ellenőrzést igényel", perServing: "Adagonként", per100g: "100 grammonként",
  ...
  de: {
    ...
    foodUnderstanding: {
      ...
      recipeDiscovery: {
        ...
        referenceMatch: "In der Keto-Mentor-Gerichtedatenbank gefunden:",
        ambiguousLocal: "Mehrere eigene Rezepte mit ähnlichem Namen — bitte eines wählen.",
        ambiguousReference: "Welche Variante hattest du? Bitte wählen (z. B. die Beilage).",
        sourceOwn: "Eigenes Rezept",
        sourceReference: "Keto-Mentor-Gerichtedatenbank",
        servingApprox: "1 Portion ≈ {g} g",
    ...
    recipes: {
      ...
      totalNutrition: "Gesamtes Rezept", partialNutrition: "Zwischensumme der aufgelösten Zutaten", ingredientsProgress: "{resolved} / {total} Zutaten aufgelöst", ingredientsNeedReview: "{n} Zutaten müssen noch geprüft werden", perServing: "Pro Portion", per100g: "Pro 100 Gramm",
  ...
  en: {
    ...
    foodUnderstanding: {
      ...
      recipeDiscovery: {
        ...
        referenceMatch: "Found in the Keto Mentor dish database:",
        ambiguousLocal: "Several of your own recipes share this name — choose one.",
        ambiguousReference: "Which version did you have? Choose one (e.g. the side dish).",
        sourceOwn: "Your recipe",
        sourceReference: "Keto Mentor dish database",
        servingApprox: "1 serving ≈ {g} g",
    ...
    recipes: {
      ...
      totalNutrition: "Whole recipe", partialNutrition: "Resolved ingredients subtotal", ingredientsProgress: "{resolved} / {total} ingredients resolved", ingredientsNeedReview: "{n} ingredients still need review", perServing: "Per serving", per100g: "Per 100 g",
