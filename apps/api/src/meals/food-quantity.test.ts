...
describe("food quantity conversion", () => {
  ...
  it("allows user override only for estimates", () => expect(convertFoodQuantity({ quantity: 2, unit: "serving", servingId: "slice", gramsOverride: 30 }, [estimate]).snapshot).toMatchObject({ gramsPerUnit: 30, method: "user_override", estimated: true }));
