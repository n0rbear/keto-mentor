...
canonicalIdentity must be the SHORTEST, most GENERIC en-US English identity for the food itself — never a specific prepared dish, brand, or product category the food merely appears in, unless the ingredient line itself already names that category (a sauce/paste/cream stays a sauce/paste/cream, never simplified down to its base ingredient — e.g. a "paprika cream" product stays a paprika/pepper paste, never bare "paprika").
